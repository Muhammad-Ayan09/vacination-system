    ...
    <div class="login-section">
        <div class="login-card">
            ...
            <form action="" method="post">
                ...
                <button type="submit" name="btnregister" class="login-btn-full">Register</button>
            </form>
            ...
            if (isset($_POST['btnregister'])) {
                ...
                if ($result) {
                    echo "<script>alert('Registration successful!');window.location.href='patientlogin.php';</script>";
                } else {
