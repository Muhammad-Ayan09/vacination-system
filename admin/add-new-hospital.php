                ...
                <div class="form-container">
                    <form action="" method="post" enctype="multipart/form-data" class="hospital-form">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" placeholder="Hospital Name" name="name" required>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" name="btnadd" class="submit-btn">Add New Hospital</button>
                        </div>
                    </form>
                    <?php
                    if (isset($_POST['btnadd'])) {
                        ...
                        $insertQuery = "INSERT INTO tbl_hospital (name, contact, cid, email, password, address, status, image) VALUES ('$name', '$phone', '$city', '$email', '$password', '$address', '$status', '$path')";
                        $result = mysqli_query($connection, $insertQuery);
                        if ($result) {
                            echo "<script>alert('New hospital added successfully'); 
