        ...
        <div class="main-content">
            ...
            <div class="content-area">
                <div class="content-header">
                    ...
                    <a href="patient.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back to patient</a>
                </div>
                <div class="form-container">
                    <form action="" method="post" enctype="multipart/form-data" class="hospital-form">
                        <div class="form-group">
                            <label for="name">Hospital Name</label>
                            <input type="text" id="name" placeholder="patient Name" name="name" required value="<?php echo $row['name']; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="phone">Contact Number</label>
                            <input type="number" id="phone" placeholder="patient Number" name="phone" required value="<?php echo $row['contact']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" placeholder="patient Email Address" name="email" required value="<?php echo $row['email']; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input type="password" id="password" placeholder="patient Password" name="password" required value="<?php echo $row['password']; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" id="address" placeholder="patient Full Address" name="address" required value="<?php echo $row['address']; ?>">
                        </div>
                    ...
                    if (isset($_POST['btnadd'])) {
                        ...
                        $insertQuery = "UPDATE tbl_patient SET name='$name', contact='$phone', cid='$city', email='$email', password='$password', address='$address', status='$status', image='$path' WHERE id=$_GET[id]";
