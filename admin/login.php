...
<head>
  ...
  <title>Vaccination Admin Login</title>
  ...
  <div class="grid-center">
    <div class="login-card" role="region" aria-labelledby="loginTitle">
      <div class="brand">
        ...
        <h1 id="loginTitle">Vaccination Admin</h1>
      </div>
      ...
      <form action="" method="post" novalidate>
        ...
        <div class="actions">
          <button class="btn-primary" type="submit" aria-label="Sign in to admin" name="admin_login">
            <span>Sign in</span>
        ...
        <p class="footer-text">Protected area • Authorized personnel only</p>
      </form>
    </div>
  </div>
</body>
